...
This repository contains the resources for my personal website, which is deployed using [Jekyll](https://jekyllrb.com/) and [GitHub Pages](https://pages.github.com/). Please follow the official documentation available via the links.

This site was created following the documentation of [GitHub Pages](https://docs.github.com/en/pages).
